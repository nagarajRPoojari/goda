...
class Tokenizer:
    ...
    def encode(self,  batch: list[str],  add_bos: bool = True, add_eos: bool = False, padding: bool = True, max_length:int | None = None ) -> torch.Tensor:
    ...
    def encode_to_list(self,  batch: list[str],  add_bos: bool = True, add_eos: bool = False, padding: bool = True, max_length:int | None = None ) -> list[Any]:
