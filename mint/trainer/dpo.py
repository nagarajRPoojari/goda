...
class DPOTrainer(BaseTrainer):
    ...
    def _compute_loss(
        ...
        policy_outputs = self.policy_model(concat_ids, attn_mask=concat_mask)
        ...
        with torch.no_grad():
            ref_outputs = self.reference_model(concat_ids, attn_mask=concat_mask)
    ...
    def train(self) -> None:
        ...
        for step, batch in enumerate(self.dataloader.batch_loader(split="train"), start=0):
            if (
